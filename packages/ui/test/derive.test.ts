...
describe('buildManifest', () => {
  it('returns entries for exactly Accordion, Alert, AspectRatio, Badge, Box, Button, Center, Checkbox, Container, Dialog, Field, Grid, Group, Paper, Popover, RadioGroup, Select, Stack, Switch, Tabs, Text, Textarea, TextInput, Title, and Tooltip', async () => {
    const manifest = await buildManifest();
