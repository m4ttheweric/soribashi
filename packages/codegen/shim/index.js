...
// to be this package's programmatic API.
// This directory survives for exactly one reason: ~/Documents/GitHub/tui-kit
// depends on "@soribashi/codegen": "file:../soribashi/packages/codegen" and
// must stay green without a single edit on its side until it migrates to the
// published @soribashi/core. It also keeps the `soribashi` bin alive — see
// ../bin/soribashi.js.
//
