...
import { defineCompound, type PartRenderCtx, SoribashiProvider } from '../../src/factory/index.ts';
...
describe('defineCompound — polymorphic part full <As> polymorphism', () => {
  ...
  it('PolymorphicCompoundPart type-level: as-element narrows the accepted props', () => {
    ...
    type AnchorProps = import('../../src/factory/types/polymorphic.ts').PolymorphicComponentProps<
      'a',
      { label?: string }
    >;
