...
import { createSoribashiBuilders } from '../../src/factory/create-builders.ts';
import { resetRegistry, resolveVocab } from '../../src/factory/vocabulary-registry.ts';
import { createTheme, defineVocabulary } from '../../src/theme/index.ts';
