...
import { createTheme } from '../../src/theme/create-theme.ts';
import { defineVocabulary } from '../../src/theme/define-vocabulary.ts';
...
import type { Vocabulary } from '../../src/theme/define-vocabulary.ts';
import type { ThemeComponentEntry } from '../../src/theme/theme-component-entry.ts';
