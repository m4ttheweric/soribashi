// The component factory's public API. Internal to @soribashi/core: the
// curated slice consumers get is re-exported from ../index.ts.

export type { VocabularyOverride } from '../theme/index.ts';
