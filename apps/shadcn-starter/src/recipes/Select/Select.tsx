...
const classes = {
  ...
  trigger: [
    ...
    'bg-(--surface-raised) px-3 py-2 text-sm shadow-sm focus:outline-none',
    'focus-visible:ring-2 focus-visible:ring-(--border-focus)',
    'disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
  ].join(' '),
  value: '',
  content: [
    'relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border border-(--border-default)',
