          ...
          >
            ...
            <Tooltip side="bottom">
              <Tooltip.Trigger asChild>
                <div
                  // biome-ignore lint/a11y/noNoninteractiveTabindex: deliberate; keeps the tooltip trigger keyboard-focusable so the tooltip opens on Tab focus, not just hover
                  tabIndex={0}
