  ...
  packages/codegen/
    ...
    fixtures/
      themes/
        ...
        custom-scope.theme.ts               ← test fixture: scoped theme (app-scope style)
```
 ...
 * Output structure:
 *   1. Header comment
 *   2. Scope block (e.g. `:root` or `.app-scope`) with all light tokens + semantic vars
 ...
 * already in use at apps/adjuster/src/components/the host component library/tailwind.config.js.
 */
